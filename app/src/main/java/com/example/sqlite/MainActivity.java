...
//Below line is to add on click listener for our add course button
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbHandler.addNewCourse(courseName,
                        courseDuration, courseDescription, courseTracks);//After adding the data we are displaying a toast message
        ...
        readCourseBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { //Opening ViewCourses activity via a intent
